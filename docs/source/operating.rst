[myawesometmlsolution-534a-3f10] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [myawesometmlsolution-534a-3f10] container is NOT running**.

.. tip::
   You must have your [myawesometmlsolution-534a-3f10] container running before connecting to the Visualization and Airflow URLs.
...
.. code-block::
   ...
   docker run -d -p 38031:38031 -p 44441:44441 -p 34883:34883 \
          --env TSS=0 \
          ...
          --env SOLUTIONEXTERNALPORT=38031 \
          -v /var/run/docker.sock:/var/run/docker.sock:z \
          -v /your_localmachine/foldername:/rawdata:z \
          --env CHIP=amd64 \
          --env SOLUTIONAIRFLOWPORT=44441 \
          --env SOLUTIONVIPERVIZPORT=34883 \
...
[myawesometmlsolution-534a-3f10] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/smaurice101/raspberrypitss/tree/main/tml-airflow/dags/tml-solutions/myawesometmlsolution-534a-3f10
...
.. important::
   solution_preprocessing_dag-myawesometmlsolution-534a-3f10
...
.. important::
   VIPERHOST_PRODUCE=0.0.0.0, VIPERPORT_PRODUCE=38031, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=44197, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=36539, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=43433, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=41801, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=34793, HPDEHOST=127.0.1.1, HPDEPORT=35623, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=45261

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-7502-myawesometmlsolution-534a-3f10,solution_preprocessing_dag-myawesometmlsolution-534a-3f10, python-preprocess-9378-myawesometmlsolution-534a-3f10,solution_preprocessing_dag-myawesometmlsolution-534a-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
